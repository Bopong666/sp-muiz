    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Gejala</h3>
            ...
            <div class="col-xxl-6">
                    ...
                    <div class="input-group my-2">
                        <div class="form-outline">
                            <input type="search" class="form-control" wire:model.debounce.250ms="search"
                                placeholder="cari kode dan nama" />
                        </div>
                ...
                <table class="table text-center">
                    <thead class="thead-dark">
                        ...
                        <th class="text-capitalize">Kode Gejala</th>
                        <th class="text-capitalize">Nama Gejala</th>
                        <th class="text-capitalize">Bobot Gejala</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start">{{ $item->nama_gejala }}</td>
                            <td class="text-center">{{ $item->bobot_gejala }}</td>
                            <td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form wire:submit.prevent="store" enctype="multipart/form-data">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    ...
                                                    wire:model.defer="kode_gejala" placeholder="G01">
                                                @error('kode_gejala')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    ...
                                                    wire:model.defer="nama_gejala" placeholder="Hijau Daun">
                                                @error('nama_gejala')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="inputName" class="col-sm-4 col-form-label">Bobot</label>
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    class="form-control @error('bobot_gejala') is-invalid @enderror"
                                                    wire:model.defer="bobot_gejala" placeholder="0.8">
                                                @error('bobot_gejala')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
